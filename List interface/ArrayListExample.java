...
public class ArrayListExample
{
    public static void main(String[] args)
    {
        ...
        System.out.println("ArrayList: " + al); // Output: [bharath, kittu, abhinav, ram]
        ...
        System.out.println("ArrayList after removal: " +al); // Output: [bharath, abhinav, ram]
        
        
        // Checking if an element exists
        boolean val = al.contains("ram");
